...
from .model import CLIP, CustomTextCLIP, convert_weights_to_lp, convert_to_custom_text_state_dict,\
    resize_pos_embed, get_cast_dtype, resize_text_pos_embed, set_model_preprocess_cfg, resize_patch_pos_embed
...
def get_tokenizer(
    ...
    if 'hf_tokenizer_name' in text_config:
        tokenizer = HFTokenizer(
            ...
            "/mnt/dolphinfs/hdd_pool/docker/user/hadoop-automl/ziteng/huggingface.co/timm/ViT-SO400M-14-SigLIP",
...
def load_checkpoint(model, checkpoint_path, strict=True):
    ...
    # resize_patch_pos_embed(state_dict, model)
    if 'visual_dino.cls_token' in state_dict:
        strict=False
