...
def get_parser_args():
    ...
    parser_eval.add_argument('--recall_k', default=[1,5], type=int, help="for retrieval, select the k for Recall@K metric. ", nargs="+",)
    ...
    parser_eval.add_argument('--long_cap', default=False, action="store_true", help="whether use long caption for training")
    parser_eval.add_argument('--stage_1', default=False, action="store_true", help="stage 1 for rope distillation")
    parser_eval.add_argument('--text_path', type=str,default=None)
    parser_eval.add_argument('--context_length',default=77,type=int,help='context length for tokenizer')
